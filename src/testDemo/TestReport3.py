...
from general import KeyCodeSentUtils, Utils
...
class case_01(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        # Key_code_touch.KeyCode.touch_up(self.driver, 2)
        # Key_code_touch.KeyCode.touch_center(self.driver, 2)
        # Key_code_touch.KeyCode.touch_left(self.driver, 2)
        KeyCodeSentUtils.KeyCode.touch_right(self.driver, 2)
        KeyCodeSentUtils.KeyCode.touch_right(self.driver, 2)
        KeyCodeSentUtils.KeyCode.touch_right(self.driver, 2)
        ...
        KeyCodeSentUtils.KeyCode.touch_down(self.driver, 2)
        KeyCodeSentUtils.KeyCode.touch_down(self.driver, 2)
        KeyCodeSentUtils.KeyCode.touch_center(self.driver, 6)
    ...
    def test_case2(self):
        ...
        # title.click()
        Utils.Logging.error("当前界面：test_case2:  " + self.driver.current_activity)
        KeyCodeSentUtils.KeyCode.touch_right(self.driver, 2)
        # Key_code_touch.KeyCode.touch_left(self.driver, 2)
        # Key_code_touch.KeyCode.touch_down(self.driver, 2)
        # Key_code_touch.KeyCode.touch_up(self.driver, 2)
        ...
        KeyCodeSentUtils.KeyCode.touch_down(self.driver, 2)
        KeyCodeSentUtils.KeyCode.touch_center(self.driver, 6)
        Utils.Logging.error("当前界面：test_case222:  " + self.driver.current_activity)
        KeyCodeSentUtils.KeyCode.touch_right(self.driver, 2)
